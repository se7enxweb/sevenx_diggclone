{set-block scope=global variable=title}{'Story Diggs %pollname'|i18n('design/base',,hash('%pollname',$node.name|wash))}{/set-block}
<div class="content-view-full">
    <div class="class-poll">
        ...
        <div class="warning">
            <h2>{'Anonymous users are not allowed to vote in this story. Please log in.'|i18n('design/base')}</h2>
        </div>
        {/if}

        {if $error_existing_data}
        <div class="warning">
            <h2>{'You have already voted in this story.'|i18n('design/base')}</h2>
        </div>
        {/if}
