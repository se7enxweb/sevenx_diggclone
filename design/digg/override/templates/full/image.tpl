...
<div class="content-view-full">
    <div class="class-image">
        ...
        <div class="attribute-caption" style="font-weight:bolder;">

	{* $node.data_map.image.content.original.url|attribute(show,1) *}
	{* <a href={concat("content/download/",$node.data_map.image.contentobject_id,"/",$node.data_map.image.id,"/file/",$node.data_map.image.content.original_filename)|ezurl}>{'Download Larger Image'|i18n( 'design/ezwebin/full/image' )}</a> *}

	<a href={concat("content/download/",$node.data_map.image.contentobject_id,"/",$node.data_map.image.id)|ezurl}>{'Download Larger Image'|i18n( 'design/ezwebin/full/image' )}</a>
	
	{* <br />
	<a href={$node.data_map.image.content.original.url|ezurl}>{'Download Larger Image'|i18n( 'design/ezwebin/full/image' )}</a> *}
