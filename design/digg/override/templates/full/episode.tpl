...
<div class="border-ml"><div class="border-mr"><div class="border-mc float-break">
    ...
    <div class="content-view-full">
        ...
        {if eq( ezini( 'article', 'ImageInFullView', 'content.ini' ), 'enabled' )}
            {if $node.data_map.image.has_content}
                <div class="attribute-image">
                    {attribute_view_gui attribute=$node.data_map.image image_class=portfolio href=$node.object.data_map.image.content[original].full_path|ezurl lightbox_class="large"}
        ...
        {if $node.data_map.file.content.is_empty|not}
{*            <div class="attribute-long">
