...
<li id="main-submit"><a onclick="{if $node.depth|gt(2)}document.getElementById('btn-submit').click(); return false;{else}{/if}" href="{if $node.depth|gt(2)}https://digg.one/submit{else}https://digg.one/c#select-a-category-first{/if}">navigate to a category and submit a new story</a></li>
...
<li><a href="https://digg.one/spy/overview">digg spy</a></li>
...
{def $total_count=0
    ...
    {else}
        ...
        No stories here yet, login and bucket <a onclick="{if $node.depth|gt(2)}document.getElementById('btn-submit').click(); return false;{else}{/if}" href="{if $node.depth|gt(2)}https://digg.one/submit{else}https://digg.one/c#select-a-category-first{/if}">submit a story</a> to the {$node.name|wash} category of digg.
    {/if}
    {else}
    {if $children_count}
