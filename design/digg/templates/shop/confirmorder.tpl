...
<ul>
    <li>1. {"Shopping cart"|i18n("design/ezwebin/shop/confirmorder")}</li>
...
*}
    <th>
    {"Total price"|i18n("design/ezwebin/shop/confirmorder")}
    </th>
</tr>
{section name=ProductItem loop=$order.product_items show=$order.product_items sequence=array(bglight,bgdark)}
<tr class="bglight">
    <td colspan="2">    <input type="hidden" name="ProductItemIDList[]" value="{$ProductItem:item.id}" />
...
{*    <th>{"Total ex. VAT"|i18n("design/ezwebin/shop/confirmorder")}</th> *}
    <th>{"Total"|i18n("design/ezwebin/shop/confirmorder")}</th>
</tr>
<tr class="bglight">
    <td>
