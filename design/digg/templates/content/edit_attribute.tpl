...
<div
{if array('diggs','enable_comments','star_rating')|contains($attribute.contentclass_attribute_identifier)} style="display:none"{/if} class="block ezcca-edit-datatype-{$attribute.data_type_string} ezcca-edit-{$attribute_identifier}">
