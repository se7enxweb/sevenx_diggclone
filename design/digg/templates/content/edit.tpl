...
{def $content_language = ezini( 'RegionalSettings', 'Locale' )}
    ...
    <input class="defaultbutton" type="submit" name="PublishButton" value="{'Post Story'|i18n( 'design/ezwebin/content/edit' )}" title="{'Publish the contents of the draft that is being edited. The draft will become the published version of the object.'|i18n( 'design/ezwebin/content/edit' )}" />
    ...
    <input class="button" type="submit" name="DiscardButton" value="{'Cancel'|i18n( 'design/ezwebin/content/edit' )}" title="{'Discard the draft that is being edited. This will also remove the translations that belong to the draft (if any).'|i18n( 'design/ezwebin/content/edit' ) }" />
