...
<div class="attribute-header">
    <h1 class="long">{"Signup"|i18n("design/ezwebin/user/register")}</h1>
</div>
...
{if count($content_attributes)|gt(0)}
    ...
    {if and( is_set( $checkErrNodeId ), $checkErrNodeId )|not()}
        <input class="button" type="submit" id="PublishButton" name="PublishButton" value="{'Signup'|i18n('design/ezwebin/user/register')}" onclick="window.setTimeout( disableButtons, 1 ); return true;" />
    {else}    
           <input class="button" type="submit" id="PublishButton" name="PublishButton" disabled="disabled" value="{'Signup'|i18n('design/ezwebin/user/register')}" onclick="window.setTimeout( disableButtons, 1 ); return true;" />
    {/if}
    <input class="button" type="submit" id="CancelButton" name="CancelButton" value="{'Cancel'|i18n('design/ezwebin/user/register')}" onclick="window.setTimeout( disableButtons, 1 ); return true;" />
    </div>
{else}
    <div class="warning">
