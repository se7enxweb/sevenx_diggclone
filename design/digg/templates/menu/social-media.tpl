<ul class="social-media">
  <li>
    <a class="social-link" href="https://facebook.com/thebigfunny" title="Facebook">
  ...
  <li>
    <a class="social-link" href="https://www.instagram.com/YourFaultOfficial" title="Instagram">
      <svg class="gb-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(var(--gb-fill-color) / var(--gb-fill-opacity));">
  ...
  <li>
    <a class="social-link" href="https://twitter.com/YourFaultFor" title="Twitter/X">
      <svg class="gb-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(var(--gb-fill-color) / var(--gb-fill-opacity));">
  ...
  <li>
    <a class="social-link" href="https://YourFaultForWatching.com/rss/feed/site" title="Website RSS Feed">
      <svg class="gb-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(var(--gb-fill-color) / var(--gb-fill-opacity));">
